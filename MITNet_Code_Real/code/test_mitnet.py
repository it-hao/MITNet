...
from model.snet_v5 import SNet as Net
...
parser.add_argument('--pre_train', type=str, default='../experiment/models/mitnet/model_best.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='haze4k', help='indoor, outdoor, haze4k, nh, dense')
parser.add_argument("--downsample", type=int, default=16, help='maxmium downsample factor')
parser.add_argument("--batch_size", type=int, default=1, help='batch size')
parser.add_argument("--save_path", type=str, default='../experiment/test_res', help='Save restoration results')
...
if opt.dataset == 'indoor':
    test_data_dir = '/mnt/f/DataSets/dehazing/SOTS/indoor'
    
elif opt.dataset == 'outdoor':
    test_data_dir = '/mnt/f/DataSets/dehazing/SOTS/outdoor'

elif opt.dataset == 'haze4k':
    test_data_dir = '/mnt/f/DataSets/dehazing/Haze4K/test_haze4k'
    
elif opt.dataset == 'dense':
    test_data_dir = '/mnt/f/DataSets/dehazing/Dense/val_dense'

elif opt.dataset == 'nh':
    test_data_dir = '/mnt/f/DataSets/dehazing/NH/val_nh'
