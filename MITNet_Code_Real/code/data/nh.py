...
class NH(srdata.SRData):
    def __init__(self, args, train=True):
        super(NH, self).__init__(args, train)
        self.args = args
        self.repeat = 100
        self.idx_scale = 0
    ...
    def _set_filesystem(self, dir_data):
        if self.train: 
            self.apath = dir_data + '/' + self.args.data_train  + '/train_nh'  
        else:
            self.apath = dir_data + '/' + self.args.data_train  + '/val_nh'  
        self.ext = '.png'
