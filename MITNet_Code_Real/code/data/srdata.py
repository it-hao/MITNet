...
class SRData(data.Dataset):
    ...
    def _load_file(self, idx):
        ...
        # For Dense and NH
        hazy_root, hazy_name = os.path.split(hazy_path) #  /home/zhao/hao/dehazing/Dense/train_dense/hazy    01_hazy.png
        gt_root = hazy_root.replace("hazy", "gt")       #  /home/zhao/hao/dehazing/Dense/train_dense/gt      01_GT.png

        hazy_filename = os.path.splitext(hazy_name)[0] # 01_hazy
        gt_filename = hazy_name.split('_')[0] + '_GT'  # 01_GT
        gt_path = os.path.join(gt_root, gt_filename + self.ext) # /home/zhao/hao/dehazing/Dense/train_dense/gt/01_GT.png 
