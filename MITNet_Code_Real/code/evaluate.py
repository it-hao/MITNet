...
parser.add_argument('--pre_train', type=str, default='../ckpt/mitnet_nh_best.pt', help="Path to pretrained model") 
parser.add_argument("--dataset", type=str, default='nh', help='indoor, outdoor, nh, dense')
